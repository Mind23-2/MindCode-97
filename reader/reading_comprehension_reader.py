...
class DataProcessor(object): 
    ...
    def data_generator(self,
        ...
        return wrapper
        return ds.GeneratorDataset(wrapper,  ['src_ids', 'sent_ids', 'input_mask', 'start_positions', 'end_positions'])
...
if __name__ == '__main__':
    train_file = 'data/mrqa/mrqa-combined.dev.raw.json'
    vocab_file = 'pretrain_model/bert/vocab.txt'
    do_lower_case = True
