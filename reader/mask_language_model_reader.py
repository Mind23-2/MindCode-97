...
def get_input_shape(args):
    ...
    """
    train_input_shape = {"backbone": [([-1, args.max_seq_len, 1], 'int32'),
                                      ([-1, args.max_seq_len, 1], 'int32'),
                                      ([-1, args.max_seq_len, 1], 'int32'),
                                      ([-1, args.max_seq_len, 1], 'int32')],
                         "task": [([-1, int(args.max_seq_len*0.15)], 'int32'),
                                  ([-1, int(args.max_seq_len*0.15)], 'int32')]
                         }

    test_input_shape = {"backbone": [([-1, args.max_seq_len, 1], 'int32'),
                                     ([-1, args.max_seq_len, 1], 'int32'),
                                     ([-1, args.max_seq_len, 1], 'int32'),
                                     ([-1, args.max_seq_len, 1], 'int32')],
                         "task": [([-1, 1], 'int32'),
...
class DataProcessor(object): 
    ...
    def data_generator(self, phase='train', shuffle=True, dev_count=1):
        ...
        next(wrapper())
        return wrapper
        return ds.GeneratorDataset(wrapper, ['src_ids', 'sent_ids', 'input_mask', 'mask_label', 'mask_pos'])#, 'label'])
